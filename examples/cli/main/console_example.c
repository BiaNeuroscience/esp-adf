...
static void cli_setup_player(void)
{
    ...
    audio_element_handle_t i2s_reader_el = i2s_stream_init(&i2s_reader);
    i2s_stream_set_clk(i2s_reader_el, 48000, 16, 2);
    ...
    esp_audio_input_stream_add(player, i2s_reader_el);
